class Solution:
    def sortColors(self, nums: List[int]) -> None:
        ...
        while current <= high:
            #high is a position that has not been processed yet now i understand i was not thinking about high it also moves that is why
# high is a position that has not been processed yet
            #[1,0,2]
            if nums[current] == 0:
                #known region
